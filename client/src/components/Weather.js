...
export default function Weather({ city }) {
  ...
  return <div>
    <div className="main-weather">
      <h2 className="title is-2" id="weather-title">   {Math.round(weathers.main.temp)}°C</h2>      <img src={`http://openweathermap.org/img/w/${weathers.weather[0].icon}.png`} id="weather-picture" alt='picture of the weather' width="80" />
    </div>
